...
class MetamaskWalletPage extends StatefulWidget {
  MetamaskWalletPage({Key? key}) : super(key: key);

  @override
  _MetamaskWalletPageState createState() => _MetamaskWalletPageState();
}
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          ...
          image: NetworkImage(
              "https://images.unsplash.com/photo-1625806335841-75e5a65ef4f0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80"),
          fit: BoxFit.cover,
          colorFilter:
